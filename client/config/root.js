      ...
      <RouterSelector history={history} location={props.location} context={props.context}>
        <Startup>
          <Switch>
            ...
            <Route exact path="/third" component={() => <Home />} />
            <Route exact path="/fourth" component={() => <Home />} />
            <Route exact path="/fifth" component={() => <Home />} />
            <Route exact path="/sixth" component={() => <Home />} />
            <Route exact path="/seventh" component={() => <Home />} />
            <Route exact path="/eighth" component={() => <Home />} />
            <Route exact path="/nine" component={() => <Home />} />
